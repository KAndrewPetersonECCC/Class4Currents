...
BJOB=${WDIR}/JOBS/giops_Class4Currents.${DATE}.${CHARLY:0:1}${FILTER:0:1}.sh
NJOB=${WDIR}/JOBS/giops_Class4Currents.${NEXT}.${CHARLY:0:1}${FILTER:0:1}.sh
PJOB=${WDIR}/JOBS/giops_Class4Currents.${DATE}.${CHARLY:0:1}${FILTER:0:1}.py
